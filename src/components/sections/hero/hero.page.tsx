      ...
      >
        {!showOverlay && (
          <video
            ...
            muted
            className={`duration-1500 absolute left-0 top-0 h-full w-full object-cover transition-opacity ${
        ...
        >
          ...
          {showBurstBubbles && (
            <Bubbles
              numBubbles={100} // High number for burst effect
              sizeRange={[10, 40]}
              durationRange={[1, 5]}
              delayRange={[0.1, 0.5]}
              opacityRange={[0.5, 1]}
              ...
              boxShadowRange={[5, 15]}
              colors={[
                'rgba(255, 255, 255, 0.2)', // Light translucent white
                'rgba(224, 255, 255, 0.35)', // Light cyan
              ]}
            />
          )}
          <Bubbles
            numBubbles={50} // Regular bubbles
            sizeRange={[20, 70]}
            durationRange={[10, 15]}
            delayRange={[1, 5]}
