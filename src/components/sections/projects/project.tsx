      ...
      <Link href={link} target="_blank">
        ...
        >
          ...
          <Image
            ...
            quality={95}
            className={`absolute -right-40 top-8 hidden w-[28.25rem] rounded-t-lg sm:block ${
              title.toLowerCase() === 'filedrive' ? '' : 'shadow-2xl'
            } transition group-even:-left-40 group-even:right-[initial] group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-hover:scale-[1.04] group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-3 group-even:group-hover:rotate-2`}
          />
        </section>
      </Link>
    </motion.div>
